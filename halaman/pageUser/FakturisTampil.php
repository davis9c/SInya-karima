...
<script>
    $(document).ready(function(){
        $(".idSales").click(function(){
            ...
            t = "../halaman/pageUser/FakturisTampilDetail.php?id=" + t;
            $("#salesAction").load(t);
            console.log(t);
        });
        $(".editSales").click(function(){
            event.preventDefault();
            var t = $(this).attr('href');
            t = "../halaman/pageUser/FakturisTampilEdit.php?id=" + t;
            $("#salesAction").load(t);
            console.log(t);
        });
        $(".HapusSales").click(function(){
            event.preventDefault();
            var t = $(this).attr('href');
            t = "../halaman/pageUser/FakturisTampilHapus.php?id=" + t;
            $("#salesAction").load(t);
